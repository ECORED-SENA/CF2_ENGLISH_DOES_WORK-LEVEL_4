      ...
      .col-lg
        .p-1.h-100
          .tarjeta-avatar
            ...
            .tarjeta.color-cuartiario
              .p-4
                .row.align-items-center
                  .col-3
                    .p-4.bg-color6
                      p.mb-0.text-center #[b T]
                  .col
                    TarjetaAudio.color-primario(
        ...
        .row.bg-color20
          ...
          .col-lg-10
            .p-4
              ...
              p.mb-0 #[i #[b.txt-color4 Yes = Yes, subject + did.]]
              p.mb-4 #[i #[b.txt-color4 No = No, subject + didn't.]]
              p.text-white.mb-4 A las preguntas de “sí” o “no”, se puede responder de forma corta:
              p.text-white.mb-0 #[b Sí = #[i Yes], sujeto + #[i did].]
              p.text-white.mb-0 #[b No = #[i No], sujeto + #[i didn't].]
